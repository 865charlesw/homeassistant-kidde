...
3. In the `custom_components` directory (folder) create a new folder called `kidde`.
4. Download _all_ the files from the `custom_components/kidde/` directory (folder) in this repository.
...
[buymecoffee]: https://www.buymeacoffee.com/865charlesw
